...
const steps = [
    ...
    { step_text: 'Put lemon chicken in oven', step_number: 2, recipe_id: 2 },
    { step_text: 'Set oven to 500', step_number: 3, recipe_id: 2 },
    { step_text: 'Cut salmon', step_number: 1, recipe_id: 3 },
